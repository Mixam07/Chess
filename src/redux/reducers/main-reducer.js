...
let initialState = {
    arrangement:[
        ...
        [
            ...
            {type: "pawn", color: "black"}, {type: "pawn", color: "black", isPossibleMove: true}, {type: "pawn", color: "black", isPossibleMove: true}, {type: "pawn", color: "black"}
        ],
        [{}, {}, {}, {}, {}, {}, {}, {}],
        [{}, {}, {}, {}, {}, {}, {}, {}],
        [{}, {}, {}, {isPossibleMove: true}, {}, {}, {}, {}],
        [{}, {}, {}, {}, {}, {}, {}, {}],
        [
            {type: "pawn", color: "white", isPossibleMove: true}, {type: "pawn", color: "white", isPossibleMove: true}, {type: "pawn", color: "white"}, {type: "pawn", color: "white"},
            ...
            return {
                ...
                arrangement: state.arrangement.map((arr, q) => {
                    return arr.map((item, i) => {
                        if((q === (action.arrId + direction) && i === action.id && !item.type)
                        || (q === (action.arrId + direction) && (i === (action.id - 1) || i === (action.id + 1)) && item.color === opponentColor)) {
                            return{
                                ...item,
                                isPossibleMove: true
                            }
